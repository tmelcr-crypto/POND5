 ...
 * like the other buttons' icons). Adding a kind: one entry here, then a source in app/items.js.
 */
export const KINDS = {
  apple: { name: 'Apple', use: 'eat', r: 0.04, color: 0xb8322a, icon: '<path d="M12 7.5c-2.2-2-6.5-1.4-6.5 3.6 0 4.2 2.6 8.4 4.6 8.4.8 0 1.1-.5 1.9-.5s1.1.5 1.9.5c2 0 4.6-4.2 4.6-8.4 0-5-4.3-5.6-6.5-3.6z"/><path d="M12 7.5c0-2 .8-3.6 2.4-4.5"/><path d="M12.5 5.2c1.4-1.3 3.4-1.2 4.3-.4-1 1-2.9 1.2-4.3.4z"/>' },
